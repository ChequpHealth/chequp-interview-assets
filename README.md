...
See the prep note you were sent ("what to expect and how to prepare"). In short: before the session, stand up an empty, running skeleton in your chosen stack with these tokens and the dictionary wired in. Don't build the feature itself — we do that part live.
